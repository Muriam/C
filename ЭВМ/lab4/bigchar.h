...
int big[17][2] = {{0x3C428181,0x8181423C}, // каждое большое число представлено двумя 16-ричным числами
		  {0x070F0707,0x07070707}, // просматривая из побитово
		  {0x7CC60E1C,0x1870E0FF}, // мы ставим пусто, если 0
		  {0xFF0303FF,0xFF0303FF}, // и закрашиваем ячейку, если 1
