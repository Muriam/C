...
main()							//главная функция
{
	...
	while (1)					//бесконечный цикл
	{
		...
		else if (P21 == 0)		//иначе если кнопка 3 нажата звучит нота ми 
			P0 = note3_mi;
		Time();
		
		else if (P21 == 0)		//иначе если кнопка 4 нажата звучит нота фа 
			P0 = note4_fa;
		Time();
		
		else if (P21 == 0)		//иначе если кнопка 5 нажата звучит нота соль 
			P0 = note5_sol;
		Time();
		
		else if (P21 == 0)		//иначе если кнопка 6 нажата звучит нота ля 
			P0 = note6_la;
		Time();
		
		else if (P21 == 0)		//иначе если кнопка 7 нажата звучит нота си 
			P0 = note7_si;
		Time();					
	}						
}
